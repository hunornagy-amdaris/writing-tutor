...
export const buildQuizSystemPrompt = (input: QuizGenerationRequest): string => {
  ...
  return [
    ...
    '   - "stem": a clear, simple-English question under 12 words asking which form/word is correct in the context.',
    '   - "options": an array of 3 or 4 short strings. Exactly ONE is correct (the corrected form). Distractors must be plausible variants a learner would confuse (wrong tense, wrong article, wrong preposition, wrong collocation, etc.).',
    '   - "correctIndex": the zero-based index of the correct option in "options".',
    '',
    '2. GAP-FILL (gap):',
