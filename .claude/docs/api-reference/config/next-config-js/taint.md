...
* `experimental_taintObjectReference` to taint object references.
...
> **Warning:** Do not rely on the taint API as your only mechanism to prevent exposing sensitive data to the client. See the security recommendations.
