...
| ------------------------------------------- | ------------------- | ------------------- | -------------------------- | ----------------- |
| [`src`](#src)                               | No | Yes | String or Array of Objects | Yes               |
| [`weight`](#weight)                         | Yes | Yes | String or Array            | Required/Optional |
| [`style`](#style)                           | Yes | Yes | String or Array            | -                 |
| [`subsets`](#subsets)                       | Yes | No | Array of Strings           | -                 |
| [`axes`](#axes)                             | Yes | No | Array of Strings           | -                 |
| [`display`](#display)                       | Yes | Yes | String                     | -                 |
| [`preload`](#preload)                       | Yes | Yes | Boolean                    | -                 |
| [`fallback`](#fallback)                     | Yes | Yes | Array of Strings           | -                 |
| [`adjustFontFallback`](#adjustfontfallback) | Yes | Yes | Boolean or String          | -                 |
| [`variable`](#variable)                     | Yes | Yes | String                     | -                 |
| [`declarations`](#declarations)             | No | Yes | Array of Objects           | -                 |
